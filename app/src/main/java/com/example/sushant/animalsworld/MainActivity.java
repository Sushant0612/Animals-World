package com.example.sushant.animalsworld;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Hide the keyboard when application open
    ...
    public void submitAnswers(View view) {
        ...
        // Question 1 - Correct Answer is #3 (Reptile)
        ...
        // Question 2 - Correct Answer is "Honey Bee"
        ...
        if (answer2.equals("honey bee") || answer2.equals("bee")) {
            answer2_score = 1;
        } else {
            answer2_score = 0;
        }

        // Question 3  - Correct Answers are #2(Lion) and #3 (Fox)
        ...
        // Question 4 - Correct Answer is "No"
        ...
        // Question 5  - Correct Answers is #2 "Dog"
        ...
        // Question 6 - Correct Answer is "Africa"
        ...
        if (answer6.equals("africa")) {
            answer6_score = 1;
        } else {
            answer6_score = 0;
        }

        // Question 7  - Correct Answers are #1Jaguar and #4Cheetah)
        ...
        // Question 8 - Correct Answer is "dog"
        ...
        if (answer8.equals("dog")) {
            answer8_score = 1;
        } else {
            answer8_score = 0;
        }

        // Question 9  - Correct Answers is #2 "Army"
        ...
        // Question 10 - Correct Answer is "invertebrates"
        ...
        if (answer10.equals("invertebrates") || answer10.equals("invertebrate")) {
            answer10_score = 1;
        } else {
            answer10_score = 0;
        }
        ...
        Toast toast = Toast.makeText(context, resultsDisplay, Toast.LENGTH_LONG);
        toast.show();
    }
}